...
wav_path = '/ceph/csedu-scratch/project/wdamen/thesis-experiments/sampleset/augm'
data_path = '/ceph/csedu-scratch/project/wdamen/thesis-experiments/results/wavernn'

# model ids are separate - that way you can use a new tts with an old wavernn and vice versa
# NB: expect undefined behaviour if models were trained on different DSP settings
voc_model_id = 'kicks_augm'
...
fft_bins = n_fft // 2 + 1
num_mels = 80
hop_length = 275                    # 12.5ms - in line with Tacotron 2 paper (--> 7.25ms with 44.1kHz)
win_length = 1100                   # 50ms - same reason as above (--> 25ms with 44.1 kHz)
fmin = 40
min_level_db = -100
ref_level_db = 20
bits = 16                            # bit depth of signal
...
voc_total_steps = 300_000
voc_test_samples = 250              # How many unseen samples to put aside for testing
