...
from augment import create_augm_data_split
...
def parse_arguments():
    ...
    parser.add_argument('-lf', '--layer-fading', dest='fading', type=str, default=None)
    parser.add_argument('-pgan', '--epochs-per-layer', dest='epochs_per_layer', type=int, default=None, help='Progressive growing')
...
if __name__ == '__main__':
    ...
    if not args['augment']:
        ...
        train_gen, valid_data, test_data \
            = create_augm_data_split(audio_filepaths, args['valid_ratio'], args['test_ratio'],
                                batch_size, batch_size, batch_size)
